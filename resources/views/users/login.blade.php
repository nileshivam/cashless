...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <link href="{{ URL::to('js/plugins/perfect-scrollbar/perfect-scrollbar.css') }}" type="text/css" rel="stylesheet" media="screen,projection">
@endsection
...
@section('content')
  ...
  <!-- jQuery Library -->
  <script type="text/javascript" src="{{ URL::to('js/jquery-1.11.2.min.js')}}"></script>
  <!--materialize js-->
  <script type="text/javascript" src="{{ URL::to('js/materialize.js') }}"></script>
  <!--prism-->
  <script type="text/javascript" src="{{ URL::to('js/prism.js') }}"></script>
  <!--scrollbar-->
